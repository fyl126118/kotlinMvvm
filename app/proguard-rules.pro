...
-keep,includedescriptorclasses class com.kotlin.mvvm.**$$serializer { *; } # <-- xxx.xxx.xxx换成自己的包名
-keepclassmembers class com.kotlin.mvvm.** { # <-- xxx.xxx.xxx换成自己的包名
    *** Companion;
}
-keepclasseswithmembers class com.kotlin.mvvm.** { # <-- xxx.xxx.xxx换成自己的包名
